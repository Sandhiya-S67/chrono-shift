              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm rounded-xl border border-white/10">
                ...
                >
                  <button
                    ...
                    className="group relative px-8 py-4 bg-primary hover:bg-primary/90 text-primary-foreground font-display text-xl md:text-2xl rounded-sm shadow-[0_0_20px_rgba(219,39,819,0.6)] hover:shadow-[0_0_40px_rgba(219,39,819,0.8)] transition-all flex items-center gap-3 mx-auto"
                  >
